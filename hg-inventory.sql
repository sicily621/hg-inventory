...
CREATE TABLE `hg_inventory`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1958076146376646659 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_inventory
-- ----------------------------
INSERT INTO `hg_inventory` VALUES (1958076146120794114, 1954455089243312130, 1952918491823816705, 1952986337115324418, 1953005820022308865, 3.00, '2025-08-20 15:58:27', '2025-08-21 14:34:20', 0);
INSERT INTO `hg_inventory` VALUES (1958076146376646658, 1954455665985277953, 1952918491823816705, 1952986337115324418, 1953005820022308865, 2.00, '2025-08-20 15:58:27', '2025-08-20 17:36:59', 0);
...
CREATE TABLE `hg_inventory_history`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1958417364373635074 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存流水表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_inventory_history
-- ----------------------------
INSERT INTO `hg_inventory_history` VALUES (1958076147295199233, 1954455089243312130, 1952918491823816705, 1952986337115324418, 1953005820022308865, 1, NULL, 1.00, 1950095792504283138, NULL, '2025-08-20 15:58:27', '2025-08-20 15:58:27', 0);
INSERT INTO `hg_inventory_history` VALUES (1958076147345530882, 1954455665985277953, 1952918491823816705, 1952986337115324418, 1953005820022308865, 1, NULL, 1.00, 1950095792504283138, NULL, '2025-08-20 15:58:27', '2025-08-20 15:58:27', 0);
INSERT INTO `hg_inventory_history` VALUES (1958077334660718593, 1954455089243312130, 1952918491823816705, 1952986337115324418, 1953005820022308865, 4, NULL, 1.00, 1950095792504283138, NULL, '2025-08-20 16:03:11', '2025-08-20 16:03:11', 0);
INSERT INTO `hg_inventory_history` VALUES (1958100943366135810, 1954455665985277953, 1952918491823816705, 1952986337115324418, 1953005820022308865, 2, NULL, 1.00, 1950095792504283138, NULL, '2025-08-20 17:36:59', '2025-08-20 17:36:59', 0);
INSERT INTO `hg_inventory_history` VALUES (1958417364373635073, 1954455089243312130, 1952918491823816705, 1952986337115324418, 1953005820022308865, 1, NULL, 1.00, 1950095792504283138, NULL, '2025-08-21 14:34:20', '2025-08-21 14:34:20', 0);
...
CREATE TABLE `hg_inventory_receipt`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1958417363266338818 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '入库表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_inventory_receipt
-- ----------------------------
INSERT INTO `hg_inventory_receipt` VALUES (1958417363266338817, 'r1', 1958417183091621890, 1950095792504283138, '', '2025-08-21 14:34:20', '2025-08-21 14:34:20', 0);
...
CREATE TABLE `hg_inventory_receipt_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1958417363786432514 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '入库明细表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_inventory_receipt_detail
-- ----------------------------
INSERT INTO `hg_inventory_receipt_detail` VALUES (1958417363786432513, 1958417363266338817, 1952678553081520129, 1954455089243312130, 1.00, 50.00, 50.00, 1952918491823816705, 1952986337115324418, 1953005820022308865, 1, NULL, NULL, '2025-08-21 14:34:20', '2025-08-21 14:34:20', 0);
...
CREATE TABLE `hg_purchase_demand_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1958417128045576197 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购需求详情表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_purchase_order`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1958417183091621891 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_purchase_order
-- ----------------------------
INSERT INTO `hg_purchase_order` VALUES (1954808533861224449, 1954553304370216962, 'order1', 1953021744750215169, 1950095792504283138, '2025-08-11 15:33:55', '1970-01-01 08:00:00', 7, 230.00, '', 1950095792504283138, '2025-08-11 17:36:16', '2025-08-11 15:34:08', '2025-08-11 22:32:57', 0);
INSERT INTO `hg_purchase_order` VALUES (1954925305106599937, 1954924574878273538, '006', 1953021744750215169, 1950095792504283138, '2025-08-11 23:17:14', '1970-01-01 08:00:00', 7, 250.00, '', 1950095792504283138, '2025-08-11 23:19:32', '2025-08-11 23:18:08', '2025-08-11 23:21:08', 0);
INSERT INTO `hg_purchase_order` VALUES (1957087369869955074, 1954911141189513218, 'o1', 1953021744750215169, 1950095792504283138, '2025-08-17 22:29:15', '1970-01-01 08:00:00', 4, 100.00, '', NULL, NULL, '2025-08-17 22:29:25', '2025-08-21 14:16:27', 0);
INSERT INTO `hg_purchase_order` VALUES (1958417183091621890, 1958417019979333633, 'oo1', 1953021744750215169, 1950095792504283138, '2025-08-21 14:33:26', '1970-01-01 08:00:00', 5, 390.00, '', NULL, NULL, '2025-08-21 14:33:37', '2025-08-21 14:34:20', 0);
...
CREATE TABLE `hg_purchase_order_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1958417183477497860 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单明细表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_purchase_order_detail
-- ----------------------------
INSERT INTO `hg_purchase_order_detail` VALUES (1954808534125465602, 1954808533861224449, 1954455089243312130, 1952678553081520129, 4.00, 50.00, 200.00, '2025-08-11 15:34:08', '2025-08-11 15:34:08', 0);
INSERT INTO `hg_purchase_order_detail` VALUES (1954808534125465603, 1954808533861224449, 1954455374657310721, 1952678553081520129, 1.00, 30.00, 30.00, '2025-08-11 15:34:08', '2025-08-11 15:34:08', 0);
INSERT INTO `hg_purchase_order_detail` VALUES (1954925305303732225, 1954925305106599937, 1954455089243312130, 1952678553081520129, 2.00, 50.00, 100.00, '2025-08-11 23:18:08', '2025-08-11 23:18:08', 0);
INSERT INTO `hg_purchase_order_detail` VALUES (1954925305303732226, 1954925305106599937, 1954455665985277953, 1952678553081520129, 3.00, 50.00, 150.00, '2025-08-11 23:18:08', '2025-08-11 23:18:08', 0);
INSERT INTO `hg_purchase_order_detail` VALUES (1957087370008367105, 1957087369869955074, 1954455089243312130, 1952678553081520129, 1.00, 50.00, 50.00, '2025-08-17 22:29:25', '2025-08-17 22:29:25', 0);
INSERT INTO `hg_purchase_order_detail` VALUES (1957087370008367106, 1957087369869955074, 1954455665985277953, 1952678553081520129, 1.00, 50.00, 50.00, '2025-08-17 22:29:25', '2025-08-17 22:29:25', 0);
INSERT INTO `hg_purchase_order_detail` VALUES (1958417183477497857, 1958417183091621890, 1954455089243312130, 1952678553081520129, 3.00, 50.00, 150.00, '2025-08-21 14:33:37', '2025-08-21 14:33:37', 0);
INSERT INTO `hg_purchase_order_detail` VALUES (1958417183477497858, 1958417183091621890, 1954455374657310721, 1952678553081520129, 3.00, 30.00, 90.00, '2025-08-21 14:33:37', '2025-08-21 14:33:37', 0);
INSERT INTO `hg_purchase_order_detail` VALUES (1958417183477497859, 1958417183091621890, 1954455665985277953, 1952678553081520129, 3.00, 50.00, 150.00, '2025-08-21 14:33:37', '2025-08-21 14:33:37', 0);
...
CREATE TABLE `hg_purchase_return`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1954926060345561091 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购退货表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_purchase_return
-- ----------------------------
INSERT INTO `hg_purchase_return` VALUES (1954913931748040706, '001', 1954808533861224449, 1950095792504283138, 1953021744750215169, 1, 230, '', NULL, '1970-01-01 08:00:00', '2025-08-11 22:32:57', '2025-08-11 22:32:57', 0);
INSERT INTO `hg_purchase_return` VALUES (1954926060345561090, '008', 1954925305106599937, 1950095792504283138, 1953021744750215169, 2, 100, '', 1950095792504283138, '2025-08-20 18:48:42', '2025-08-11 23:21:08', '2025-08-21 14:16:19', 0);
...
-- ----------------------------
INSERT INTO `hg_purchase_return_detail` VALUES (1954913931878064129, 1954913931748040706, 1954455089243312130, 1952678553081520129, 4.00, 50.00, 200.00, '2025-08-11 22:32:57', '2025-08-11 22:32:57', 0);
INSERT INTO `hg_purchase_return_detail` VALUES (1954913931878064130, 1954913931748040706, 1954455374657310721, 1952678553081520129, 1.00, 30.00, 30.00, '2025-08-11 22:32:57', '2025-08-11 22:32:57', 0);
INSERT INTO `hg_purchase_return_detail` VALUES (1954926060542693377, 1954926060345561090, 1954455089243312130, 1952678553081520129, 1.00, 50.00, 50.00, '2025-08-11 23:21:08', '2025-08-11 23:21:08', 0);
INSERT INTO `hg_purchase_return_detail` VALUES (1954926060542693378, 1954926060345561090, 1954455665985277953, 1952678553081520129, 1.00, 50.00, 50.00, '2025-08-11 23:21:08', '2025-08-11 23:21:08', 0);
...
INSERT INTO `hg_sales_order` VALUES (1958095881659097089, 's1', 1953018819353198594, 1950095792504283138, '2025-08-20', '1970-01-01', 4, 180.00, 0.00, 0.00, 180.00, '', 1950095792504283138, '2025-08-20 17:17:52', '2025-08-20 17:16:53', '2025-08-21 14:12:58', 0);

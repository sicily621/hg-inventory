...
-- ----------------------------
INSERT INTO `hg_inventory` VALUES (1958076146120794114, 1954455089243312130, 1952918491823816705, 1952986337115324418, 1953005820022308865, 2.00, '2025-08-20 15:58:27', '2025-08-20 16:03:10', 0);
...
CREATE TABLE `hg_inventory_history`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1958100943366135811 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存流水表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_inventory_receipt`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1958100941944266754 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '入库表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_inventory_receipt
-- ----------------------------
INSERT INTO `hg_inventory_receipt` VALUES (1958076145923661826, 'r1', 1957087369869955074, 1950095792504283138, '', '2025-08-20 15:58:27', '2025-08-20 15:58:27', 0);
INSERT INTO `hg_inventory_receipt` VALUES (1958077333473730562, 'r2', 1956551594762625026, 1950095792504283138, '', '2025-08-20 16:03:10', '2025-08-20 16:03:10', 0);
INSERT INTO `hg_inventory_receipt` VALUES (1958100941944266753, 's1', 1958095881659097089, 1950095792504283138, '', '2025-08-20 17:36:59', '2025-08-20 17:36:59', 0);
...
CREATE TABLE `hg_inventory_receipt_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1958100942917345282 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '入库明细表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_inventory_receipt_detail
-- ----------------------------
INSERT INTO `hg_inventory_receipt_detail` VALUES (1958076146703802370, 1958076145923661826, 1952678553081520129, 1954455089243312130, 1.00, 50.00, 50.00, 1952918491823816705, 1952986337115324418, 1953005820022308865, NULL, NULL, NULL, '2025-08-20 15:58:27', '2025-08-20 15:58:27', 0);
INSERT INTO `hg_inventory_receipt_detail` VALUES (1958076146703802371, 1958076145923661826, 1952678553081520129, 1954455665985277953, 1.00, 50.00, 50.00, 1952918491823816705, 1952986337115324418, 1953005820022308865, NULL, NULL, NULL, '2025-08-20 15:58:27', '2025-08-20 15:58:27', 0);
INSERT INTO `hg_inventory_receipt_detail` VALUES (1958077334132236290, 1958077333473730562, 1952678553081520129, 1954455089243312130, 1.00, 50.00, 50.00, 1952918491823816705, 1952986337115324418, 1953005820022308865, NULL, NULL, NULL, '2025-08-20 16:03:10', '2025-08-20 16:03:10', 0);
INSERT INTO `hg_inventory_receipt_detail` VALUES (1958100942917345281, 1958100941944266753, 1952678553081520129, 1954455665985277953, 1.00, 50.00, 50.00, 1952918491823816705, 1952986337115324418, 1953005820022308865, NULL, NULL, NULL, '2025-08-20 17:36:59', '2025-08-20 17:36:59', 0);
...
CREATE TABLE `hg_purchase_demand_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1954925017515757571 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购需求详情表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_purchase_order`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1957087369869955075 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `hg_purchase_order` VALUES (1957087369869955074, 1954911141189513218, 'o1', 1953021744750215169, 1950095792504283138, '2025-08-17 22:29:15', '1970-01-01 08:00:00', 6, 100.00, '', NULL, NULL, '2025-08-17 22:29:25', '2025-08-20 15:58:27', 0);
...
CREATE TABLE `hg_purchase_order_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1957087370008367107 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单明细表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `hg_purchase_return` VALUES (1954926060345561090, '008', 1954925305106599937, 1950095792504283138, 1953021744750215169, 3, 100, '', 1950095792504283138, '2025-08-20 18:48:42', '2025-08-11 23:21:08', '2025-08-20 18:48:42', 0);
...
INSERT INTO `hg_sales_order` VALUES (1958095881659097089, 's1', 1953018819353198594, 1950095792504283138, '2025-08-20', '1970-01-01', 5, 180.00, 0.00, 0.00, 180.00, '', 1950095792504283138, '2025-08-20 17:17:52', '2025-08-20 17:16:53', '2025-08-20 17:36:59', 0);

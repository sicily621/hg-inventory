...
) ENGINE = InnoDB AUTO_INCREMENT = 1972923435584000003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '收款记录表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_account
-- ----------------------------
INSERT INTO `hg_account` VALUES (1970038667502616578, 1970038499210362882, 'purchaseOrder20250922161221300', 1, 1953021744750215169, 1, 222.00, NULL, NULL, 1950095792504283138, 4, '', '2025-09-22 16:13:15', '2025-09-30 17:07:38', 0);
...
INSERT INTO `hg_account` VALUES (1972923175855919105, 1972921518896123905, 'purchaseOrder20250930150836821', 1, 1953021744750215169, 1, 50.00, NULL, NULL, 1950095792504283138, 4, '', '2025-09-30 15:15:15', '2025-09-30 15:17:07', 0);
INSERT INTO `hg_account` VALUES (1972923435584000002, 1972921518896123905, 'purchaseReturn20250930151545789', 1, 1953021744750215169, 2, 50.00, NULL, NULL, 1950095792504283138, 3, '', '2025-09-30 15:16:17', '2025-09-30 15:17:10', 0);
...
-- ----------------------------
INSERT INTO `hg_employee` VALUES (1950095792504283138, '001', 'admin', '0f2797f2182804d0cc7f0b85d254c146', 'zm', 0, '', '17312124545', '123@163.com', 0, '2025-07-29 15:27:22', '2025-10-10 17:27:44', 1952303554671882242, 0, '/static/2025/10/10/d1d2d89764aa45aeae8eabd771dff444_20251010172743A001.png', 0);
INSERT INTO `hg_employee` VALUES (1952309334494097410, '004', 'xiaoliu', '0f2797f2182804d0cc7f0b85d254c146', '小刘', 1952264115023196161, '', '17300001111', '123@163.com', 1, '2025-08-04 18:03:12', '2025-10-10 17:04:35', 1952580037491453953, 1, '/static/2025/10/10/399fc26cd5e8490691aba811cd21bf63_20251010170434A002.png', 0);
...
-- ----------------------------
INSERT INTO `hg_inventory` VALUES (1970038666403708930, 1954455089243312130, 1952918491823816705, 1952986337115324418, 1953005820022308865, 7.00, '2025-09-22 16:13:14', '2025-09-30 15:16:17', 0);
...
CREATE TABLE `hg_inventory_history`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1972923435395256323 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存流水表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_inventory_receipt`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1972923172911517699 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '入库表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_inventory_receipt_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1972923173565829122 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '入库明细表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_inventory_shipment`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1972923434149548035 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '出库表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_inventory_shipment_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1972923434870968323 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '出库明细表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1976590048208334850 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户登录日志表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_purchase_demand_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1972921490152558594 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购需求详情表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_purchase_order`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1972921518896123906 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `hg_purchase_order` VALUES (1972921518896123905, 1972920963712880641, 'purchaseOrder20250930150836821', 1950095792504283138, '2025-09-30 15:08:37', '2025-09-30 15:15:15', 8, 50.00, '', 1950095792504283138, '2025-09-30 15:09:34', '2025-09-30 15:08:40', '2025-09-30 15:15:48', 0);
...
CREATE TABLE `hg_purchase_order_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1972921520892612611 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单明细表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_purchase_return`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1972923314381197314 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购退货表' ROW_FORMAT = DYNAMIC;

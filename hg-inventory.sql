...
) ENGINE = InnoDB AUTO_INCREMENT = 1954834079097733122 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '权限表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `hg_permission` VALUES (1954833520101867522, '采购订单', 'purchaseorder', 1954554256779214850, 'purchaseManagement/purchaseorder', '', '2025-08-11 17:13:25', '2025-08-11 17:13:25', 0, 1, 1);
INSERT INTO `hg_permission` VALUES (1954834079097733121, '审批采购订单', 'purchaseorder', 1954833520101867522, 'purchaseManagement/purchaseorder', '', '2025-08-11 17:15:38', '2025-08-11 17:15:51', 0, 5, 2);
...
CREATE TABLE `hg_purchase_demand_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1954735341201223684 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购需求详情表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_purchase_order`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1954808533861224450 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_purchase_order
-- ----------------------------
INSERT INTO `hg_purchase_order` VALUES (1954808533861224449, 1954553304370216962, 'order1', 1953021744750215169, 1950095792504283138, '2025-08-11 15:33:55', '1970-01-01 08:00:00', 2, 230.00, '', 1950095792504283138, '2025-08-11 17:36:16', '2025-08-11 15:34:08', '2025-08-11 17:36:22', 0);
...
CREATE TABLE `hg_purchase_order_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1954808534125465604 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单明细表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_purchase_return`  (
  ...
  `totalAmount` int NULL DEFAULT NULL COMMENT '退单总金额',
  `description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `approver_id` bigint NULL DEFAULT NULL COMMENT '审核人ID',
  `approval_time` datetime NULL DEFAULT NULL COMMENT '审核时间',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `hg_role` VALUES (1952303554671882242, '超级管理员', 'admin', '超级管理员拥有最大权限', 1, '2025-08-04 17:40:14', '2025-08-11 17:16:04', 0);
INSERT INTO `hg_role` VALUES (1952580037491453953, '测试角色', 'test', '', 1, '2025-08-05 11:58:53', '2025-08-11 10:23:15', 0);
...
INSERT INTO `hg_role_permission` VALUES (1954730300742529026, 1952580037491453953, 1952561113785896961, '2025-08-11 10:23:15', 0, '2025-08-11 10:23:15');
INSERT INTO `hg_role_permission` VALUES (1954730300742529027, 1952580037491453953, 1952658215757062146, '2025-08-11 10:23:15', 0, '2025-08-11 10:23:15');
INSERT INTO `hg_role_permission` VALUES (1954730300742529028, 1952580037491453953, 1952658439359602690, '2025-08-11 10:23:15', 0, '2025-08-11 10:23:15');
INSERT INTO `hg_role_permission` VALUES (1954730300742529029, 1952580037491453953, 1952658612836016129, '2025-08-11 10:23:15', 0, '2025-08-11 10:23:15');
INSERT INTO `hg_role_permission` VALUES (1954730300742529030, 1952580037491453953, 1954554256779214850, '2025-08-11 10:23:15', 0, '2025-08-11 10:23:15');
INSERT INTO `hg_role_permission` VALUES (1954730300742529031, 1952580037491453953, 1954554607104262146, '2025-08-11 10:23:15', 0, '2025-08-11 10:23:15');
...
INSERT INTO `hg_role_permission` VALUES (1954834189445677057, 1952303554671882242, 1952561113785896961, '2025-08-11 17:16:04', 0, '2025-08-11 17:16:04');
INSERT INTO `hg_role_permission` VALUES (1954834189445677058, 1952303554671882242, 1952561423342309377, '2025-08-11 17:16:04', 0, '2025-08-11 17:16:04');
INSERT INTO `hg_role_permission` VALUES (1954834189445677059, 1952303554671882242, 1952562158385696769, '2025-08-11 17:16:04', 0, '2025-08-11 17:16:04');
INSERT INTO `hg_role_permission` VALUES (1954834189445677060, 1952303554671882242, 1952562778312216578, '2025-08-11 17:16:04', 0, '2025-08-11 17:16:04');
INSERT INTO `hg_role_permission` VALUES (1954834189445677061, 1952303554671882242, 1952658215757062146, '2025-08-11 17:16:04', 0, '2025-08-11 17:16:04');
INSERT INTO `hg_role_permission` VALUES (1954834189445677062, 1952303554671882242, 1952658439359602690, '2025-08-11 17:16:04', 0, '2025-08-11 17:16:04');
INSERT INTO `hg_role_permission` VALUES (1954834189445677063, 1952303554671882242, 1952658612836016129, '2025-08-11 17:16:04', 0, '2025-08-11 17:16:04');
INSERT INTO `hg_role_permission` VALUES (1954834189445677064, 1952303554671882242, 1954554256779214850, '2025-08-11 17:16:04', 0, '2025-08-11 17:16:04');
INSERT INTO `hg_role_permission` VALUES (1954834189445677065, 1952303554671882242, 1954554607104262146, '2025-08-11 17:16:04', 0, '2025-08-11 17:16:04');
INSERT INTO `hg_role_permission` VALUES (1954834189445677066, 1952303554671882242, 1954554993114447874, '2025-08-11 17:16:04', 0, '2025-08-11 17:16:04');
INSERT INTO `hg_role_permission` VALUES (1954834189445677067, 1952303554671882242, 1954833520101867522, '2025-08-11 17:16:04', 0, '2025-08-11 17:16:04');
INSERT INTO `hg_role_permission` VALUES (1954834189508591617, 1952303554671882242, 1954834079097733121, '2025-08-11 17:16:04', 0, '2025-08-11 17:16:04');

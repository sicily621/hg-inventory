...
) ENGINE = InnoDB AUTO_INCREMENT = 1978034544803192834 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '收款记录表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `hg_account` VALUES (1977629594830958593, 1977628640891039745, 'purchaseOrder20251013145257151', 1, 1953021744750215169, 1, 240.00, NULL, NULL, NULL, 1950095792504283138, 1, '', '2025-10-13 14:56:53', '2025-10-13 14:56:53', 0);
INSERT INTO `hg_account` VALUES (1977677267663515649, 1977677105822101506, 'purchaseOrder20251013180530055', 1, 1953021744750215169, 1, 120.00, NULL, NULL, NULL, 1950095792504283138, 1, '', '2025-10-13 18:06:19', '2025-10-13 18:06:19', 0);
...
CREATE TABLE `hg_inventory`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1977592629054074883 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_inventory
-- ----------------------------
INSERT INTO `hg_inventory` VALUES (1970038666403708930, 1954455089243312130, 1952918491823816705, 1952986337115324418, 1953005820022308865, 11.00, '2025-09-22 16:13:14', '2025-10-14 17:46:00', 0);
...
CREATE TABLE `hg_inventory_history`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1978034544606060547 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存流水表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_inventory_receipt`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1978021197399597059 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '入库表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_inventory_receipt_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1978021198179737602 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '入库明细表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_inventory_shipment`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1978034543691702274 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '出库表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_inventory_shipment_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1978034544144687106 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '出库明细表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1978350663271342083 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户登录日志表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_purchase_demand_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1977676647904768003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购需求详情表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_purchase_order`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1977677105822101507 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_purchase_order_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1977677106279280642 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单明细表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_purchase_return`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1977677451306921986 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购退货表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_sales_order`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1978031952459079682 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '销售订单表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_sales_order_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1978033591916044290 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '销售订单明细表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_sales_return`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1978020772806008835 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '销售退货表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_sales_return_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1978020773208662018 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '销售退货明细表' ROW_FORMAT = DYNAMIC;

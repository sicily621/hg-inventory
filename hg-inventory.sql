...
-- ----------------------------
INSERT INTO `hg_account` VALUES (1970038667502616578, 1970038499210362882, 'purchaseOrder20250922161221300', 1, 1953021744750215169, 1, 222.00, NULL, NULL, 1950095792504283138, 4, '', '2025-09-22 16:13:15', '2025-09-22 18:22:55', 0);
...
-- ----------------------------
INSERT INTO `hg_inventory` VALUES (1970038666403708930, 1954455089243312130, 1952918491823816705, 1952986337115324418, 1953005820022308865, 3.00, '2025-09-22 16:13:14', '2025-09-22 16:13:14', 0);
...
CREATE TABLE `hg_inventory_history`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1970049738791649282 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存流水表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_sales_order`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1970038159782117378 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '销售订单表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_sales_order
-- ----------------------------
INSERT INTO `hg_sales_order` VALUES (1970038159782117377, 'salesOrder20250922161051124', 1953018819353198594, 1950095792504283138, '2025-09-22', '1970-01-01', 1, 237.00, 0.00, 0.00, 237.00, '', NULL, NULL, '2025-09-22 16:11:13', '2025-09-22 16:11:13', 0);
...
CREATE TABLE `hg_sales_order_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1970038160222519300 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '销售订单明细表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hg_sales_order_detail
-- ----------------------------
INSERT INTO `hg_sales_order_detail` VALUES (1970038160222519298, 1970038159782117377, 1952678628172144642, 1954455089243312130, 3.00, 49.60, 148.80, '2025-09-22 16:11:14', '2025-09-22 16:11:14', 0);
INSERT INTO `hg_sales_order_detail` VALUES (1970038160222519299, 1970038159782117377, 1952678628172144642, 1954455374657310721, 3.00, 29.40, 88.20, '2025-09-22 16:11:14', '2025-09-22 16:11:14', 0);
...
CREATE TABLE `hg_sales_return`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1968957803892989954 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '销售退货表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hg_sales_return_detail`  (
  ...
  `del_flag` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1968957806728339458 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '销售退货明细表' ROW_FORMAT = DYNAMIC;
